...
const BackgroundCheckConsent: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-xl font-bold text-purple-700 dark:text-purple-400 mb-2">🔍 Background Check Consent</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-base font-bold text-purple-700 dark:text-purple-400">Your Decision</h3>
          
          {/* Yes Option */}
          <label 
            className={`flex items-start gap-4 p-6 rounded-xl border-2 cursor-pointer shadow-sm transition-all ${
              consent === true
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-lg font-bold">Yes, I consent</span>
              </div>
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-lg font-bold">Not at this time</span>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
