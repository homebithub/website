  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-8 bg-white dark:bg-[#13131a] rounded-2xl shadow-xl dark:shadow-glow border-2 border-purple-200 dark:border-purple-500/30">
      ...
      <div className="mb-8 p-6 bg-purple-50 dark:bg-purple-900/20 rounded-xl border-2 border-purple-200 dark:border-purple-500/30">
        <h3 className="text-lg font-bold text-primary-600 dark:text-purple-400 mb-4 flex items-center">
          ...
          <div className="flex gap-3">
            {!validationResult ? (
              <button
                ...
                disabled={!isInviteCodeComplete(inviteCode) || validating || loading}
              ...
              <button
                ...
                onClick={handleJoin}
                disabled={loading}
                className="flex-1 px-6 py-1.5 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-base shadow-lg hover:from-purple-700 hover:to-pink-700 hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/10 dark:to-pink-900/10 rounded-xl border-2 border-purple-200 dark:border-purple-500/30">
        ...
        <button
          ...
          onClick={onCreateNew}
          disabled={loading}
          className="w-full px-6 py-1.5 rounded-xl bg-white dark:bg-[#13131a] text-purple-600 dark:text-purple-400 font-bold text-base border-2 border-purple-300 dark:border-purple-500/50 shadow-md hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          🏠 Create New Household
        </button>
      </div>
