    ...
    return (
      ...
      >
        <div className="flex items-center justify-end gap-2 border-b border-gray-200/70 pb-1.5 dark:border-white/10">
          ...
          <a href="https://www.tiktok.com/@homebithubkenya" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:text-purple-400"><svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.589 6.686a4.793 4.793 0 01-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 11-2-2.757V9.39a6.337 6.337 0 105.445 6.282V8.733a8.182 8.182 0 004.773 1.526V6.824a4.83 4.83 0 01-1.003-.138z"/></svg></a>
        </div>
    ...
    <footer ref={footerRef} data-site-footer className={`${baseClasses} ${themeClasses}`}>
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://www.tiktok.com/@homebithubkenya" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-gray-400 hover:text-purple-400 hover:scale-125 transition-all duration-200">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.589 6.686a4.793 4.793 0 01-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 11-2-2.757V9.39a6.337 6.337 0 105.445 6.282V8.733a8.182 8.182 0 004.773 1.526V6.824a4.83 4.83 0 01-1.003-.138z"/></svg>
          </a>
        </div>
