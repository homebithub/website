...
export const PurpleCard: React.FC<PurpleCardProps> = ({
  ...
  const baseClasses = 'rounded-2xl bg-white/90 dark:bg-[#13131a]/95 backdrop-blur-md shadow-light-glow-md dark:shadow-glow-md border-2 border-purple-200 dark:border-purple-500/30 transition-colors duration-300';
