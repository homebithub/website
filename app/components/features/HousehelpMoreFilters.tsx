  ...
  return (
    <div className="space-y-3">
      <div className="rounded-2xl border border-gray-200/80 dark:border-gray-700/70 bg-white/70 dark:bg-black/20 overflow-hidden">
        ...
        >
          <span className="text-[11px] font-semibold text-gray-900 dark:text-gray-100">Basics & Availability</span>
          ...
          <div className="px-4 pb-4 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Status</label>
                <CustomSelect
                  value={fields.status || ""}
              ...
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Gender</label>
                <CustomSelect
                  value={fields.gender || ""}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Town</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Available From</label>
                <input type="date" value={fields.available_from || ""} onChange={(e) => onChange("available_from", e.target.value)} className={inputCls} />
              </div>
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Experience</label>
                <CustomSelect
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Language</label>
                <CustomSelect
              ...
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Skills / Can Help With</label>
                <CustomSelect
                  value={fields.skill || ""}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Trait</label>
                <CustomSelect
                  value={fields.traits || ""}
      ...
      <div className="rounded-2xl border border-gray-200/80 dark:border-gray-700/70 bg-white/70 dark:bg-black/20 overflow-hidden">
        <button
          ...
          className="w-full px-4 py-3 flex items-center justify-between text-left"
        >
          <span className="text-[11px] font-semibold text-gray-900 dark:text-gray-100">Compensation & Rating</span>
        ...
        {openSections.compensation && (
          <div className="px-4 pb-4 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Salary Frequency</label>
                <CustomSelect
              ...
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Minimum Rating</label>
                <CustomSelect
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Min Salary</label>
              ...
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Max Salary</label>
      ...
      <div className="rounded-2xl border border-gray-200/80 dark:border-gray-700/70 bg-white/70 dark:bg-black/20 overflow-hidden">
        <button
          ...
          className="w-full px-4 py-3 flex items-center justify-between text-left"
        >
          <span className="text-[11px] font-semibold text-gray-900 dark:text-gray-100">Compatibility</span>
        ...
        {openSections.compatibility && (
          <div className="px-4 pb-4 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Works with Kids</label>
                <CustomSelect
              ...
              <div className="flex flex-col">
                <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Works with Pets</label>
                <CustomSelect
            ...
            <div className="flex flex-col">
              <label className="mb-1 text-[11px] font-semibold text-gray-800 dark:text-gray-200">Age Range: {minAge} - {maxAge} years</label>
