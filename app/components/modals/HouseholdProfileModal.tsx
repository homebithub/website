...
import { NannyTypeStep } from './NannyTypeStep';
      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="flex justify-between mt-6 pt-4 border-t border-gray-200">
          <button
            ...
            className="px-4 py-1 text-gray-600 hover:text-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Previous
          </button>
          <button
            onClick={handleNext}
            className="px-6 py-1 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-colors"
          >
