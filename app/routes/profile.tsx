...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background bg-white dark:bg-slate-900">
      <Navigation />
      <main className="flex-1 flex flex-col items-center px-2 py-4 animate-fadeIn">
        <div className="w-full max-w-md sm:max-w-lg bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700 p-6 mt-4">
