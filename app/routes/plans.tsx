    ...
    >
      ...
      <div className="mb-4">
        ...
        <div className="flex items-end gap-1 mt-2">
          <span className="text-2xl font-extrabold text-white">{formatCurrency(plan.price_amount)}</span>
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="mb-8">
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-white transition-colors mb-6"
          >
        ...
        {plansLoading ? (
          ...
          <div className="max-w-md mx-auto">
            ...
            <button
              ...
              className="mt-4 w-full rounded-xl py-2.5 text-xs font-semibold text-purple-400 border-2 border-purple-500/50 hover:bg-purple-500/10 transition-colors"
            >
              Try Again
            </button>
          </div>
                ...
                <Dialog.Panel className="w-full sm:max-w-md transform overflow-hidden rounded-t-2xl sm:rounded-2xl bg-[#13131a] border border-[#1e1e2e] p-6 shadow-xl transition-all max-h-[90vh] overflow-y-auto">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 border border-[#2a2a3d] rounded-lg focus:ring-2 focus:ring-purple-500 bg-[#0d0d14] text-white text-base"
                          />
                        ...
                        <div className="flex gap-3 mt-2">
                          <button
                            ...
                            className="flex-1 px-4 py-2.5 border border-[#2a2a3d] rounded-xl hover:bg-[#1e1e2e] transition-colors disabled:opacity-50 text-xs font-medium text-gray-300"
                          >
                            Cancel
                          </button>
                          <button
                  ...
                  {paymentStatus === "processing" && (
                    <div className="text-center py-10">
                      ...
                      <p className="text-lg font-bold text-white mb-2">Check Your Phone</p>
                  ...
                  {paymentStatus === "failed" && (
                    <div className="text-center py-8">
                      ...
                      <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-xl p-4 mb-4 text-left">
                        <p className="text-xs text-yellow-300 font-medium mb-2">Common reasons for failure:</p>
                  ...
                  {paymentStatus === "timeout" && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-xl font-bold text-white mb-2">Payment Pending</p>
                      <p className="text-xs text-gray-400 mb-4">Your payment is taking longer than expected.</p>
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 px-4 py-2.5 border border-[#2a2a3d] rounded-xl text-xs font-medium text-gray-300 hover:bg-[#1e1e2e] transition-colors"
                        >
                          View History
                        </button>
                        <button
                          onClick={handleRetry}
                          className="flex-1 px-4 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl text-xs font-bold hover:from-purple-700 hover:to-pink-700 transition-all"
                        >
                          Try Again
                        </button>
                      </div>
