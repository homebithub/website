...
export const meta = () => [
  { title: "Overnight Care Waitlist — Homebit" },
  {
    name: "description",
    content:
      "Join Homebit's overnight care waitlist as a household or service provider and get early access.",
  },
];
