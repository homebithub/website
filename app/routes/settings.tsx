		...
		<div className="min-h-screen flex flex-col">
			...
			<main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
					<div className="mb-8">
						...
						<p className="text-xs text-gray-600 dark:text-gray-400">Manage your account settings and app preferences.</p>
					</div>
					
					{errorMessage && (
						<div className="mb-6 rounded-xl border border-red-200 bg-red-50 dark:bg-red-950/40 dark:border-red-500/40 text-red-700 dark:text-red-200 px-4 py-2 text-xs">
							{errorMessage}
						</div>
					)}
					{successMessage && (
						<div className="mb-6 rounded-xl border border-green-200 bg-green-50 dark:bg-emerald-950/40 dark:border-emerald-500/40 text-green-700 dark:text-green-200 px-4 py-2 text-xs">
							{successMessage}
						</div>
					)}
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
						<a href="/profile" className="bg-white dark:bg-[#13131a] rounded-2xl border border-purple-200/40 dark:border-purple-500/30 p-5 hover:border-purple-400 dark:hover:border-purple-400 transition-colors block">
							...
							<div className="font-semibold text-purple-700 dark:text-purple-300 text-xs mb-0.5">Account</div>
						...
						<a href="/change-password" className="bg-white dark:bg-[#13131a] rounded-2xl border border-purple-200/40 dark:border-purple-500/30 p-5 hover:border-purple-400 dark:hover:border-purple-400 transition-colors block">
							<div className="text-xl mb-2">🔒</div>
							<div className="font-semibold text-purple-700 dark:text-purple-300 text-xs mb-0.5">Security</div>
					...
					<div className="bg-white dark:bg-[#13131a] rounded-2xl border border-purple-200/40 dark:border-purple-500/30 p-5">
						<div className="flex items-center justify-between mb-5">
							<div>
								<h2 className="font-semibold text-gray-900 dark:text-gray-100 text-xs mb-0.5">App Preferences</h2>
						...
						<div className="space-y-4">
							<div className="flex items-center justify-between">
								<div>
									<div className="text-xs font-medium text-gray-900 dark:text-gray-100">Email notifications</div>
							...
							<div className="flex items-center justify-between">
								<div>
									<div className="text-xs font-medium text-gray-900 dark:text-gray-100">Show onboarding tips</div>
							...
							<div className="flex items-center justify-between">
								<div>
									<div className="text-xs font-medium text-gray-900 dark:text-gray-100">Compact view</div>
							...
							<div className="flex items-center justify-between">
								<div>
									<div className="text-xs font-medium text-gray-900 dark:text-gray-100">Accessibility mode</div>
						...
						<div className="mt-5 flex justify-end">
							<button
								type="button"
								className="inline-flex items-center px-4 py-1.5 text-xs font-semibold rounded-xl text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:scale-105"
