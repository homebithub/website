...
export const meta = () => [
  { title: "Special Needs Care Waitlist — Homebit" },
  {
    name: "description",
    content:
      "Join Homebit's special needs care waitlist as a household or service provider and get early access.",
  },
];
