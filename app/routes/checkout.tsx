      ...
      >
        <main className="w-full max-w-3xl mx-auto flex-1 flex items-center justify-center">
          <div className="relative w-full">
            {/* Glowing background */}
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 rounded-3xl blur-3xl opacity-40 animate-pulse" />

            {/* Card */}
            <div className="relative rounded-3xl bg-black/70 dark:bg-[#050510]/90 border border-purple-500/40 shadow-[0_0_40px_rgba(168,85,247,0.6)] px-6 sm:px-10 py-10 sm:py-12 flex flex-col items-center text-center overflow-hidden">
              ...
              <h1 className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 bg-clip-text text-transparent mb-3">
                Checkout is Coming Soon
              </h1>

              <p className="text-base sm:text-lg text-gray-300/90 max-w-xl mx-auto mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  type="button"
                  onClick={() => navigate(-1)}
                  className="inline-flex items-center justify-center px-6 py-2.5 rounded-xl border border-purple-500/60 text-sm font-semibold text-purple-100 bg-black/40 hover:bg-purple-900/40 transition-colors"
                >
                  Go Back
                </button>
              ...
              <div className="mt-10 text-[11px] uppercase tracking-[0.25em] text-gray-500">
