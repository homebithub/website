        ...
        <main className="flex-1 flex flex-col justify-center items-center px-4 py-12">
          <PurpleCard hover={false} glow={true} className="w-full max-w-lg p-8 sm:p-10">
            ...
            <div className="text-center mb-8">
              <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent dark:from-purple-400 dark:to-pink-400">
                Welcome to Homebit! 🏠
              </h1>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-900/40 text-xl">
                    🔑
                  </div>
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-pink-100 dark:bg-pink-900/40 text-xl">
                    ✨
                  </div>
                  <div className="flex-1">
                    <h3 className="text-base font-bold text-gray-900 dark:text-white mb-1">
