...
const PROFILE_COPY: Record<ProfileType, { heading: string; paragraph: string; servicePrompt: string }> = {
  household: {
    ...
    paragraph:
      "Join our elder-care waitlist to get early access to trusted caregivers and household support professionals. We are building a safer, faster way for families to find dependable care for seniors at home.",
    servicePrompt: "Would you need additional services?",
  },
  househelp: {
    heading: "You offer elder care?",
    paragraph:
      "Join our elder-care waitlist to be among the first care professionals households discover. Show your services early and get priority visibility when elder-care hiring opens.",
