                            ...
                            {editMode ? (
                                <>
                                    ...
                                    <div className="flex gap-4 mt-4">
                                        <button
                                            className="px-5 py-1 rounded-xl bg-purple-600 text-white hover:bg-purple-700 font-semibold"
                                            onClick={saveEdit}
                                            type="button"
                                        >
                                            Save
                                        ...
                                        <button
                                            className="px-5 py-1 rounded-xl bg-gray-200 dark:bg-slate-700 text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-slate-800 font-semibold"
                                            onClick={cancelEdit}
                                            type="button"
                                        >
                                            Cancel
