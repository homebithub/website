    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-white dark:bg-slate-800 rounded-xl shadow border border-gray-100 dark:border-slate-700 p-5 flex flex-col items-center"
          >
            <div className="text-3xl font-extrabold text-purple-700 dark:text-purple-300 mb-2">
              {stat.value}
            </div>
