...
export class BlogSubscriber extends jspb.Message {
  getId(): string;
  setId(value: string): BlogSubscriber;

  getEmail(): string;
  setEmail(value: string): BlogSubscriber;

  getName(): string;
  setName(value: string): BlogSubscriber;

  getIsActive(): boolean;
  setIsActive(value: boolean): BlogSubscriber;

  getToken(): string;
  setToken(value: string): BlogSubscriber;

  getSubscribedAt(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setSubscribedAt(value?: google_protobuf_timestamp_pb.Timestamp): BlogSubscriber;
  hasSubscribedAt(): boolean;
  clearSubscribedAt(): BlogSubscriber;

  getUnsubscribedAt(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setUnsubscribedAt(value?: google_protobuf_timestamp_pb.Timestamp): BlogSubscriber;
  hasUnsubscribedAt(): boolean;
  clearUnsubscribedAt(): BlogSubscriber;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): BlogSubscriber.AsObject;
  static toObject(includeInstance: boolean, msg: BlogSubscriber): BlogSubscriber.AsObject;
  static serializeBinaryToWriter(message: BlogSubscriber, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): BlogSubscriber;
  static deserializeBinaryFromReader(message: BlogSubscriber, reader: jspb.BinaryReader): BlogSubscriber;
}

export namespace BlogSubscriber {
  export type AsObject = {
    id: string;
    email: string;
    name: string;
    ...
    unsubscribedAt?: google_protobuf_timestamp_pb.Timestamp.AsObject;
  };
}

export class SubscribeToBlogRequest extends jspb.Message {
  getEmail(): string;
  setEmail(value: string): SubscribeToBlogRequest;

  getName(): string;
  setName(value: string): SubscribeToBlogRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SubscribeToBlogRequest.AsObject;
  static toObject(includeInstance: boolean, msg: SubscribeToBlogRequest): SubscribeToBlogRequest.AsObject;
  static serializeBinaryToWriter(message: SubscribeToBlogRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SubscribeToBlogRequest;
  static deserializeBinaryFromReader(message: SubscribeToBlogRequest, reader: jspb.BinaryReader): SubscribeToBlogRequest;
}

export namespace SubscribeToBlogRequest {
  export type AsObject = {
    email: string;
    name: string;
  };
...
export class SubscribeToBlogResponse extends jspb.Message {
  getMessage(): string;
  setMessage(value: string): SubscribeToBlogResponse;

  getAlreadySubscribed(): boolean;
  setAlreadySubscribed(value: boolean): SubscribeToBlogResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SubscribeToBlogResponse.AsObject;
  static toObject(includeInstance: boolean, msg: SubscribeToBlogResponse): SubscribeToBlogResponse.AsObject;
  static serializeBinaryToWriter(message: SubscribeToBlogResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SubscribeToBlogResponse;
  static deserializeBinaryFromReader(message: SubscribeToBlogResponse, reader: jspb.BinaryReader): SubscribeToBlogResponse;
}

export namespace SubscribeToBlogResponse {
  export type AsObject = {
    message: string;
...
export class UnsubscribeFromBlogRequest extends jspb.Message {
  getToken(): string;
  setToken(value: string): UnsubscribeFromBlogRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UnsubscribeFromBlogRequest.AsObject;
  static toObject(includeInstance: boolean, msg: UnsubscribeFromBlogRequest): UnsubscribeFromBlogRequest.AsObject;
  static serializeBinaryToWriter(message: UnsubscribeFromBlogRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UnsubscribeFromBlogRequest;
  static deserializeBinaryFromReader(message: UnsubscribeFromBlogRequest, reader: jspb.BinaryReader): UnsubscribeFromBlogRequest;
}

export namespace UnsubscribeFromBlogRequest {
  export type AsObject = {
    token: string;
  };
}

export class ListBlogSubscribersRequest extends jspb.Message {
  getLimit(): number;
  setLimit(value: number): ListBlogSubscribersRequest;

  getOffset(): number;
  setOffset(value: number): ListBlogSubscribersRequest;

  getActiveOnly(): boolean;
  setActiveOnly(value: boolean): ListBlogSubscribersRequest;

  getSearch(): string;
  setSearch(value: string): ListBlogSubscribersRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ListBlogSubscribersRequest.AsObject;
  static toObject(includeInstance: boolean, msg: ListBlogSubscribersRequest): ListBlogSubscribersRequest.AsObject;
  static serializeBinaryToWriter(message: ListBlogSubscribersRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ListBlogSubscribersRequest;
  static deserializeBinaryFromReader(message: ListBlogSubscribersRequest, reader: jspb.BinaryReader): ListBlogSubscribersRequest;
}

export namespace ListBlogSubscribersRequest {
  export type AsObject = {
    limit: number;
    offset: number;
    activeOnly: boolean;
...
export class ListBlogSubscribersResponse extends jspb.Message {
  getSubscribersList(): Array<BlogSubscriber>;
  setSubscribersList(value: Array<BlogSubscriber>): ListBlogSubscribersResponse;
  clearSubscribersList(): ListBlogSubscribersResponse;
  addSubscribers(value?: BlogSubscriber, index?: number): BlogSubscriber;

  getTotal(): number;
  setTotal(value: number): ListBlogSubscribersResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ListBlogSubscribersResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ListBlogSubscribersResponse): ListBlogSubscribersResponse.AsObject;
  static serializeBinaryToWriter(message: ListBlogSubscribersResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ListBlogSubscribersResponse;
  static deserializeBinaryFromReader(message: ListBlogSubscribersResponse, reader: jspb.BinaryReader): ListBlogSubscribersResponse;
}

export namespace ListBlogSubscribersResponse {
  export type AsObject = {
    subscribersList: Array<BlogSubscriber.AsObject>;
    total: number;
  };
}

export class BlogSubscriberCountResponse extends jspb.Message {
  getTotal(): number;
  setTotal(value: number): BlogSubscriberCountResponse;

  getActive(): number;
  setActive(value: number): BlogSubscriberCountResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): BlogSubscriberCountResponse.AsObject;
  static toObject(includeInstance: boolean, msg: BlogSubscriberCountResponse): BlogSubscriberCountResponse.AsObject;
  static serializeBinaryToWriter(message: BlogSubscriberCountResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): BlogSubscriberCountResponse;
  static deserializeBinaryFromReader(message: BlogSubscriberCountResponse, reader: jspb.BinaryReader): BlogSubscriberCountResponse;
}

export namespace BlogSubscriberCountResponse {
  export type AsObject = {
    total: number;
    active: number;
  };
