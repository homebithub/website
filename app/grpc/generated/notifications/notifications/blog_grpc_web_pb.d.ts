...
export class BlogServiceClient {
  ...
  subscribeToBlog(
    request: notifications_blog_pb.SubscribeToBlogRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: notifications_blog_pb.SubscribeToBlogResponse) => void
  ): grpcWeb.ClientReadableStream<notifications_blog_pb.SubscribeToBlogResponse>;

  unsubscribeFromBlog(
    request: notifications_blog_pb.UnsubscribeFromBlogRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: google_protobuf_empty_pb.Empty) => void
  ): grpcWeb.ClientReadableStream<google_protobuf_empty_pb.Empty>;
  ...
  listBlogSubscribers(
    request: notifications_blog_pb.ListBlogSubscribersRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: notifications_blog_pb.ListBlogSubscribersResponse) => void
  ): grpcWeb.ClientReadableStream<notifications_blog_pb.ListBlogSubscribersResponse>;

  getBlogSubscriberCount(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: notifications_blog_pb.BlogSubscriberCountResponse) => void
  ): grpcWeb.ClientReadableStream<notifications_blog_pb.BlogSubscriberCountResponse>;
...
export class BlogServicePromiseClient {
  ...
  subscribeToBlog(
    request: notifications_blog_pb.SubscribeToBlogRequest,
    metadata?: grpcWeb.Metadata
  ): Promise<notifications_blog_pb.SubscribeToBlogResponse>;
  ...
  listBlogSubscribers(
    request: notifications_blog_pb.ListBlogSubscribersRequest,
    metadata?: grpcWeb.Metadata
  ): Promise<notifications_blog_pb.ListBlogSubscribersResponse>;

  getBlogSubscriberCount(
    request: google_protobuf_empty_pb.Empty,
    metadata?: grpcWeb.Metadata
  ): Promise<notifications_blog_pb.BlogSubscriberCountResponse>;
